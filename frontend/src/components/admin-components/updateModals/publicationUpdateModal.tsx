    ...
    useEffect(() => {
        ...
        if (initialData) {
            ...
            setFormData({
                ...
                journalQuartile: (initialData.journalQuartile && ['Q1', 'Q2', 'Q3', 'Q4'].includes(String(initialData.journalQuartile).toUpperCase().trim())) ? String(initialData.journalQuartile).toUpperCase().trim() : '',
